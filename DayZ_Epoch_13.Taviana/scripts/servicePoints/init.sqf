...
_servicePointClasses = ["Map_A_FuelStation_Feed","Land_A_FuelStation_Feed","FuelPump_DZ","US_WarfareBVehicleServicePoint_Base_EP1"]; // service point classes, You can also use dayz_fuelpumparray by its self for all the default fuel pumps.
_maxDistance = 150; // maximum distance from a service point for the options to be shown
