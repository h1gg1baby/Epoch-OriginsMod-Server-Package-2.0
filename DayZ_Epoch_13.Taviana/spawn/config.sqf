...
spawn_public = call {
	...
	if ((toLower worldName) in ["tavi","taviana"]) exitwith {
		[
            ...
            ["Ekaterinburg",[11211,19073,0],0,0],
			["llya",[5842,17493,0],0,0],
			["Shtangrad",[3721,7774,0],0,0],
			["Kryvoe",[9234,5429,0],0,0],
			["Vladimir",[2388,16722,0],0,0],
			["Baranovka",[10681,10119,0],0,0],
			["Bandit Sector",[23069,20128.754,0],0,0],
			["Seven",[11277,861,0],0,0]
		]
	};
