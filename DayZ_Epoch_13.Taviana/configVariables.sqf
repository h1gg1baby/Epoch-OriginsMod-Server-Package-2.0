...
dayz_infectiouswaterholes = false; //Enable infected waterholes, randomly adds some bodies, graves and wrecks by ponds (negatively impacts FPS), not supported by all maps
...
if (!isDedicated) then {
	...
	DZE_BuildingLimit = 555; // Maximum allowed objects per plot
