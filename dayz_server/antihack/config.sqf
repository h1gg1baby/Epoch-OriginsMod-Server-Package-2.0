...
local _missionFiles = ["configVariables.sqf","description.ext","init.sqf","mission.sqm","rules.sqf","stringtable.xml","dayz_code\compile\ui_selectSlot.sqf","dayz_code\DZAI_Client\dzai_client_config.sqf","dayz_code\DZAI_Client\dzai_initclient.sqf","dayz_code\init\compiles.sqf","dayz_code\init\variables.sqf","scripts\fix.sqf","scripts\safe_zones.sqf","scripts\additions\combineBandage.sqf","scripts\additions\unpackBandage.sqf","scripts\additions\use_item.sqf","scripts\clickActions\config.sqf","scripts\deployAnything\config.sqf","scripts\deployAnything\deploy.sqf","scripts\deployAnything\functions.sqf","scripts\deployAnything\init.sqf","scripts\deployAnything\pack.sqf","scripts\deployAnything\player_deploy.sqf","scripts\deployAnything\wrapper.sqf","scripts\servicePoints\init.sqf","scripts\servicePoints\servicePointActions.sqf","spawn\config.sqf","spawn\init.sqf","spawn\main.sqf","spawn\functions\class_fillItems.sqf","spawn\functions\class_fillList.sqf","spawn\functions\class_pick.sqf","spawn\functions\class_preview.sqf","spawn\functions\class_randomMags.sqf","spawn\functions\class_randomTools.sqf","spawn\functions\class_wipeGear.sqf","spawn\functions\cleanup.sqf","spawn\functions\finish.sqf","spawn\functions\spawn_fill.sqf","spawn\functions\spawn_map.sqf","spawn\functions\spawn_pick.sqf"];
