...
#include "spawn_markers\markers_taviana.sqf"	//Load manual spawn point definitions file.
...
#include "custom_markers\cust_markers_taviana.sqf"
#include "custom_spawns\cust_spawns_taviana.sqf"
