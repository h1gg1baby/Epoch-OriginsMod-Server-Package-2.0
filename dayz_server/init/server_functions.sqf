call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\Ekaterinburgtrader.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\tavianazoo.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\schwarzmarkt.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\shtangradtrader.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\traderllya.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\truckdealer.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\maps\traderfix.sqf";
